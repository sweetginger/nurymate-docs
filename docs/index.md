...
**BEP**: 판매자 약 114명 *(거래 마진 1.5% 기준)* / Phase 2 목표 300명 달성 시 월 +9,897만 원 흑자 전환

> 월 고정비 기준: 인건비 9명 × 500만 원 + AWS 인프라 약 103만 원 + 기타 500만 원 = **약 5,103만 원**
> 거래 마진 1.0% 시 BEP 판매자 170명 / 2.0% 시 판매자 85명. PG 마진(0.5%) 포함 시 실질 BEP 하향 조정됨. 최소 **2억 원 운영 자금 선확보** 필요 (런칭~BEP 도달 약 4~5개월 런웨이). → [`pricing-model.md` 섹션 4 참조](./pricing-model.md)
