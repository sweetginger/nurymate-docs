...
**누리메이트는 한국에서 시작해 일본·동남아까지 하나의 플랫폼으로 운영하는 차세대 헤드리스 이커머스 SaaS입니다.**

카페24처럼 한국 쇼핑몰을 쉽게 만들 수 있고, Shopify처럼 글로벌 확장이 가능하되, 둘 다 잘 못하는 **아시아 크로스보더 결제와 현지화**를 네이티브로 지원합니다.
...
> ⚠️ **미정** — 구체적인 수수료율 및 구간은 2026년 3월 25일 전략 회의에서 확정 예정. (`pricing-model.md` 초안 참조)

- 월 매출 일정 기준 이하: **수수료 0%** (초기 판매자 진입 장벽 제거)
...
**BEP**: 판매자 약 123명 *(거래 마진 1.5% 기준)* / Phase 2 목표 300명 달성 시 월 +9,447만 원 흑자 전환

> 월 고정비 기준: 인건비 9명 × 550만 원 + AWS 인프라 약 103만 원 + 기타 500만 원 = **약 5,553만 원**
> 거래 마진 1.0% 시 BEP 판매자 185명 / 2.0% 시 판매자 93명. PG 마진(0.5%) 포함 시 실질 BEP 하향 조정됨. 최소 **2억 원 운영 자금 선확보** 필요 (런칭~BEP 도달 약 4~5개월 런웨이). → [`pricing-model.md` 섹션 4 참조](./strategy/pricing-model.md)
...
| **2026년 6월** | 1차 런칭 (한국 베타) — 카페24 이탈 판매자 + 신규 창업자 타겟 |
...
| 문서 | 설명 |
|------|------|
| [product-plan.md](./strategy/product-plan.md) | 핵심 제품 기획서 |
| [business-roadmap.md](./strategy/business-roadmap.md) | Phase별 사업 로드맵 |
| [pricing-model.md](./strategy/pricing-model.md) | 수익 구조 설계 |
| [strategic-analysis.md](./strategy/strategic-analysis.md) | SWOT·Lean Canvas·포지셔닝 분석 |
| [vertical-expansion.md](./strategy/vertical-expansion.md) | 버티컬 확장 전략 (패션→식품→코스메틱) |
| [organic-growth.md](./strategy/organic-growth.md) | SEO·AEO·GEO 자연 유입 전략 |
| [japan-gtm.md](./strategy/japan-gtm.md) | 일본 진출 GTM 전략 |
| [global-expansion-roadmap.md](./strategy/global-expansion-roadmap.md) | 글로벌 시장 진입 우선순위 |
| [early-customer-acquisition.md](./strategy/early-customer-acquisition.md) | 초기 고객 확보 전략 |
| [new-seller-acquisition.md](./strategy/new-seller-acquisition.md) | 신규 창업자 타겟 확보 전략 |
| [api-policy.md](./strategy/api-policy.md) | API 공개 및 써드파티 연동 정책 |
