...
**셀메이트CM은 누구나 30분 만에 쇼핑몰을 열고, 복잡한 설정 없이 글로벌 시장을 하나의 플랫폼으로 운영하는 차세대 헤드리스 이커머스 SaaS입니다.**
...
셀메이트CM은 단독 제품이 아니라 **셀메이트의 사업 범위 확장** 맥락에서 탄생했습니다.
...
이 때문에 셀메이트CM은 **스토어X처럼 소수의 특정 판매자를 타겟하는 버티컬 전략을 취하지 않습니다.** 스토어X는 깊은 버티컬 특화로 단가를 높이는 모델이지만, 판매 채널 사업은 판매자 수와 GMV 총량이 수익의 직접 변수이므로 범용 솔루션으로 매출 파이를 키우는 전략이 맞습니다.
...
| AI 온보딩 | ❌ | △ | ✅ 30분 셋업 |
| 수수료 | 2.5~6% | 2.9%+월정액 | **플랫폼 0~2% + PG 2.4%**¹ |
| 통합 정산 대시보드 | ❌ | ❌ | ✅ |

> ¹ 판매자 실질 총 부담: PG 수수료(2.4%) + 플랫폼 수수료(0~2%) = **총 약 2.4~4.4%**. 경쟁사 카페24의 "2.5~6%"는 PG + 판매수수료 합산 기준. 동일 조건 비교 시 셀메이트CM은 초기 구간(월 매출 500만 원 이하) PG 수수료만 발생(약 2.4%), 이후 슬라이딩 플랫폼 수수료 추가.
...
> **월 거래액 20억 원, 플랫폼 마진율 1% 기준** → 월 수익 2,000만 원
...
- ※ "플랫폼 마진율"은 내부 take rate 기준 (PG 수수료 2.4% 별도). 판매자 실질 부담 총 약 3.4% (PG 2.4% + 플랫폼 마진 1%)
...
> 2026-03-25 확정 방향성 기준 — **한국·일본 진입 우선**. 크로스보더·글로벌 확장 문서는 [`global-expansion.md`](./global-expansion.md)에서 관리.
...
| [pricing-model.md](./pricing-model.md) | 수익 구조 설계 (슬라이딩 수수료·PG 마진) |
| [strategic-analysis.md](./strategic-analysis.md) | SWOT·Lean Canvas·포지셔닝 분석 |
| [seo-migration.md](./seo-migration.md) | 마이그레이션 시 SEO 보존 전략 |
...
| 문서 | 설명 |
|------|------|
| [early-customer-acquisition.md](./early-customer-acquisition.md) | 초기 고객 확보 전략 (셀메이트 버티컬 진입) |
...
| [spec/ad-service-strategy.md](./spec/ad-service-strategy.md) | P2 | 광고 대행사 파트너 연동 서비스 |
| [spec/influencer-matching.md](./spec/influencer-matching.md) | P2 | 인플루런서 매칭 |
...
| [research/cafe24-pain-points.md](./research/cafe24-pain-points.md) | 카페24 불만 포인트 — 국내·해외 반응 분리 |
| [research/o2o-success-cases.md](./research/o2o-success-cases.md) | O2O 성공 사례 (올리브영·신세계·다이소 등) |
...
| [research/japan-ec-solutions.md](./research/japan-ec-solutions.md) | 일본 EC 솔루션 조사 (futureshop, ecbeing, W2) |
| [research/japan-ec-agency-structure.md](./research/japan-ec-agency-structure.md) | 일본 EC 에이전시 구조 및 라쿠텐 연동 전략 |
