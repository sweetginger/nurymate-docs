...
> ⚠️ **[현재 보류 — 2026-03-25 전략 확정]**
> 2026-03-25 전략 회의에서 Stripe Connect 기반 미국 법인 구조 추진 보류 결정.
> 크로스보더 결제보다 한국·일본 국내 결제 우선 집중.
> (한국: 이니시스·토스페이먼츠 / 일본: GMO·SBPS via 셀메이트 일본 법인)
> 본 조사 내용은 향후 크로스보더 재검토 시 참고용으로 보관.

> 조사일: 2026-03-10 | 목적: 셀메이트CM 글로벌 결제 인프라 설계
...
Stripe Atlas는 비미국 거주자(외국인)도 미국 Delaware C-Corp 또는 LLC를 온라인으로 설립할 수 있는 서비스다. 셀메이트CM가 한국·일본이 아닌 **미국 법인 기반으로 Stripe Connect를 운영**하려는 경우의 기반 옵션이다.
...
미국 법인 플랫폼(셀메이트CM)으로부터 정산을 받는 한국 셀러:
