...
> 조사일: 2026-03-10 | 목적: 누리메이트 SNS 마케팅 연동 기능 설계
...
**커머스 연동 제한**: X는 Meta·TikTok 대비 커머스 카탈로그 연동 기능 미흡. 누리메이트 연동 우선순위 낮음
...
- 스마트스토어 연동 vs 독립몰(누리메이트 기반) 전략 충돌 가능성 검토 필요
...
1. **카탈로그 피드 중앙화**: 누리메이트 상품 DB → 단일 피드로 Meta·TikTok·Pinterest·Google Merchant Center 동시 연동
