...
> 조사일: 2026-03-10 | 목적: 누리메이트 통계·분석 기능 방향성 결정
...
- 누리메이트 타겟 사용자(한국 소규모 쇼핑몰 운영자)에게는 특히 높은 장벽
...
### 5-3. '보완'이 핵심: ShopifyQL이 못하는 것을 누리메이트가 해야

ShopifyQL의 구조적 한계를 역이용하여 차별화 포인트 설계:

| ShopifyQL 한계 | 누리메이트 차별화 방향 |
|---------------|---------------------|
...
- 누리메이트도 **기본 통계(무료 또는 초급 플랜)** + **고급 분석·커스텀 대시보드(중상위 플랜)** 차등 제공으로 자연스러운 업셀링 레버 활용 가능
